...
namespace Lab3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            a = a.ToRadians(); Console.WriteLine($"a as radians: {a}"); 
            a = a.ToTurns();

            Console.WriteLine($"a as turns: {a}"); a = a.ToDegrees(); 
            ...
            a.Units = AngleUnits.Turns; for (int i = 0; i < 10; ++i) { a -= .20m; Console.WriteLine(a); }
